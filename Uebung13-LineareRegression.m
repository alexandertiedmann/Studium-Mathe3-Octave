...
[a,b]=linReg(xm,ym)
%Ausgabe
IntMin=[min(ym),min(xm)];
IntMax=[max(ym),max(xm)];
intervall=[min(IntMin):0.1:max(IntMax)];
func=@(xm)a.*xm.+b;
y=func(intervall);
figure('Name',"Aufgabe 13",'NumberTitle','off'), 
subplot(2,3,1),line(intervall,y),line(xm,ym,"linestyle","none","marker","*","color",'r'),title("13.1")
...
func=@(xm)a.*xm.+b;
y=func(intervall);
subplot(2,3,2),line(intervall,y),line(xm,ym,"linestyle","none","marker","*","color",'r'),title("13.2")
...
IntMax=[max(ym),max(xm)];
intervall=[min(IntMin):0.1:max(IntMax)];
func=@(xm)a.*xm.^2.+b.*xm.+c;
y=func(intervall);
subplot(2,3,3),line(intervall,y),line(xm,ym,"linestyle","none","marker","*","color",'r'),title("13.3")
...
[a,b,c]=quadReg(xm,ym)
%Ausgabe
intervall=[min(xm):0.1:max(xm)+1];
func=@(xm)a.*xm.^2.+b.*xm.+c;
y=func(intervall);
subplot(2,3,4),line(intervall,y),line(xm,ym,"linestyle","none","marker","*","color",'r'),title("13.4")
...
func=@(xm)a.*exp(b.*xm);
y=func(intervall);
subplot(2,3,5),line(intervall,y),line(xm,ym,"linestyle","none","marker","*","color",'r'),title("13.5")